...
title: Travel hacks
---
Travel is one of those activities where small mistakes cascade into larger ones, and where simple preparations can make a huge impact on the quality of your travelling wellbeing.
...
Take a quick picture of the inside of your packed suitcase/bags and save it with your other documents.
...
International data plans can be expensive, but they are worth it just to get GPS.
...
Use colored handle straps to avoid looking for the generic black, medium-sized carry-on.

Put contact information both inside and outside the bag.
...
It is annoying to do, but it would be even more annoying to bring these unwanted guests with you back home.
...
- Avoid using the closets, but use the system in your carry-on as your closet.
...
Everyone has their own technique for how to cope with jetlag.
...
Light helps synchronizing your inner clock, be that either sunlight or strong artificial ligthing.
